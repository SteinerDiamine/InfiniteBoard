...
export const Navbar = () => {
  ...
  return (
    <div className="flex items-center justify-between p-5 bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg shadow-lg transform transition duration-300 ease-in-out hover:scale-105 floating">
